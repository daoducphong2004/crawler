...
for book in books:
    ...
    # Fetch the page content with delay to avoid 429 error
    ...
    for volume_section in volume_sections:
        ...
        # Add a random delay between 1 and 5 seconds to avoid 429 errors
        delay = random.uniform(1, 5)
        print(f"Waiting for {delay:.2f} seconds to avoid 429 error...")
        time.sleep(delay)
